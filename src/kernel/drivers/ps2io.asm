...
; code key table
code_key_table: 
db 27,'1','2','3','4','5','6','7','8','9','0','-','=',8,0xfe,'q','w','e','r','t','y','u','i','o','p','[',']',10,0xfe,'a','s','d','f','g','h','j','k','l',';',39,'`',0xfe,92,'z','x','c','v','b','n','m',',','.','/',0xfe
code_key_table2:
...
code_key_table3: times 4*20 db 0xfe
code_key_table4: db 0xff,0xff,0xff,0xfe,0xfe,0xff,0xff,0xff
code_key_table5: times 4*41 db 0xff
code_key_table6: db 0


shift_code_key_table: 
db 27,'!','@','#','$','%','&','&','*','(',')','_','+',8,0xfe,'Q','W','E','R','T','Y','U','I','O','P','{','}',10,0xfe,'A','S','D','F','G','H','J','K','L',':',34,'~',0xfe,'|','Z','X','C','V','B','N','M','<','>','?',0xfe
shift_code_key_table2:
db '*',0xfe,' ',0xfe,0xfe,0xfe,0xfe,0xfe,0xfe,0xfe,0xfe,0xfe,0xfe,0xfe,0xfe,0xfe,'7','8','9','-','4','5','6','+','1','2','3','0','.',0xff,0xff,0xff,0xfe,0xfe,0xff,0xff,0xff,0xff
shift_code_key_table3: times 4*20 db 0xfe
shift_code_key_table4: db 0xff,0xff,0xff,0xfe,0xfe,0xff,0xff,0xff
shift_code_key_table5: times 4*41 db 0xff
shift_code_key_table6: db 0
; code key table